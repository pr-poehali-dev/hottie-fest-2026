...
const SHOW_NOMINATIONS = [
  {
    ...
    level: "Продвинутый",
    levelColor: "#e8151b",
    desc: "Все женские стили на каблуках: frame up, стрип, high heels. Опытные танцоры с хорошей техникой. Сложная постановка номера.",
    price: 1500,
  },
  {
    id: "ladies-beg",
    ...
    level: "Начинающий",
    levelColor: "#888",
    desc: "Все женские стили на каблуках: frame up, стрип, high heels. Хореограф не участвует в номере. Лёгкая постановка.",
    price: 1500,
  },
  {
    id: "best-show",
    ...
    level: "Любой",
    levelColor: "#888",
    desc: "Любые стили, выступление без каблуков. Команда от 3 человек. Длительность 3–4 минуты. Реквизит по согласованию.",
    price: 1500,
  },
  {
    id: "duet",
...
const SOLO_NOMINATIONS = [
  ...
  },
  {
    ...
    level: "Начинающий",
    levelColor: "#888",
    desc: "Номинация для начинающих. Исключает участие действующих педагогов и танцоров продвинутого уровня.",
    price: 2000,
    limit: "Лимит: 20 участников",
  },
  {
      ...
      <section id="conditions" className="py-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5 mt-12">
            {[
              { icon: "ShieldCheck", title: "Свободный выбор", text: "Руководитель самостоятельно выбирает номинацию в соответствии с уровнем и опытом команды." },
              { icon: "Award", title: "Финалисты", text: "Три финалиста выбираются в конце каждого блока. Награждение проводится в конце мероприятия." },
      ...
      <section id="important" className="py-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-4">
            {[
              { icon: "Clock", title: "Регистрация до 17 мая", text: "Команда считается зарегистрированной после 100% оплаты. Инструкция по оплате приходит в течение 48 часов." },
              { icon: "Music", title: "Музыка до 17 мая", text: "Отправляйте на hottiefest@mail.ru. Тема: «музыка на хоти». Файл MP3, название: НОМИНАЦИЯ_КОМАНДА_С ТОЧКИ." },
              { icon: "AlertTriangle", title: "Возврат взноса", text: "Если вы отказываетесь от участия после оплаты — взнос не возвращается." },
              { icon: "TrendingUp", title: "Повышение цены", text: "После 10 мая стоимость участия повышается — плюс 300 ₽ к каждой номинации." },
              { icon: "Timer", title: "Ограничения по времени", text: "Solo — до 2:30 · Duet — до 3:30 · Команды — до 4:00" },
